...
var __insert = s1+s2+s3+s4;
  ...
  return {
    ...
    */
    ...
    /*
      Find intersection of up to three samples by pulling their distinct values (either
    ...
    */
    ...
    aggregateF: function(callback){
      ...
      db.open(function(err, db) {
        ...
        db.createCollection("temp", function(err,result){

          db.collection('temp',function(err,temp){
            ...
            db.collection(u_db, function(err, coll_udb) {
              ...
              if(!err){
                ...
                /*******************************************************************
                                              DISTINCT IN A                            */
                coll_udb.distinct(user_selection,{"projectRun":s1},function(err,docs1){
                ...
                console.log(docs1.length);
                 ...
                 /*******************************************************************
                                            DISTINCT IN B                            */
                  coll_udb.distinct(user_selection,{"projectRun":s2},function(err,docs2){
                  ...
                  console.log(docs2.length);
                    ...
                    /*******************************************************************
                                            DISTINCT IN C                            */
                    coll_udb.distinct(user_selection,{"projectRun":s3},function(err,docs3){
                   ...
                   if(!err && docs3.length>0){
                    ...
                    coll_udb.distinct(user_selection,{"projectRun":s4},function(err,docs4) {
                    ...
                    console.log(docs4.length);
                      ...
                      //clear and recreate temp document
                       ...
                       temp.remove({_id:__insert},function(err,numRemoved){ 

                          temp.insert({_id:__insert,set1:docs1,set2:docs2,set3:docs3,set4:docs4,global_intersection:GLOBAL_INTERSECTION},function(err,result) {
